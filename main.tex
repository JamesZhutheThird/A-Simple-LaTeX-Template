...
\section{MATLAB代码}
\label{appcode:demo1}
\lstinputlisting[style=matlabStyle]{src/demo.m}

\section{Python代码}
\label{appcode:demo2}
\lstinputlisting[style=pythonStyle]{src/demo.py}
...
\lstinputlisting[language=sql]{src/demo.sql}

\lstinputlisting[language=matlab]{src/demo.m}
